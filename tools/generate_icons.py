...
def convert_svg_to_png(svg_path, output_path, size):
    ...
    try:
        ...
        try:
            ...
            print(f"✓ Generated {output_path.name} ({size}x{size}) from SVG using ImageMagick")
            return True
        except (subprocess.CalledProcessError, FileNotFoundError):
            print(f"⚠ Could not convert SVG: cairosvg and ImageMagick not available")
            return False
...
def generate_monochrome_variants():
    ...
    if alpha:
        light_rgba = Image.merge('RGBA', (light_pixels, light_pixels, light_pixels, alpha))
...
def generate_web_icons():
    ...
    print(f"✓ Generated site.webmanifest")
...
def generate_start9_icon():
    ...
    resized.save(output_path, 'PNG', optimize=True)
    print(f"✓ Generated icon.png for Start9")
...
def generate_social_images():
    ...
    print(f"✓ Generated og-1200x630.png")
    ...
    print(f"✓ Generated square-1080.png")
